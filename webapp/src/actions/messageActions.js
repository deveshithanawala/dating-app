...
// Get messages for current logged in user from database and pass to reducer
...
// Add a new message sent by current logged in user to message state
...
// Add a new message to the database and pass updated messages to state
